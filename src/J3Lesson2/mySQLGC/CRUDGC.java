...
import J3Lesson2.mySQLGC.IConstantsMySQL;
...
class CRUDGC implements IConstantsMySQL {
    ...
    private CRUDGC openDBFile(String dbName) { // open/create database
        try {
            Class.forName(DRIVER_NAME);
            connect = DriverManager.getConnection(dbName,"sd30","-----");
